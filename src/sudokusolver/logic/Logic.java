...
public class Logic {
    ...
    public Logic(Board startingBoard) {
    ...
    public FillResult solve() {
        ...
        System.out.println("SimpleFill used.");
        ...
        if (copyBoard.isComplete()) {
            ...
            System.out.println("LookAheadOneFill used.");
            ...
            if (copyBoard.isComplete()) {
                ...
                System.out.println("LookAheadTwoFill used.");
    ...
    public SimpleFillResult simpleFill(Board board, Set<Cell> newFilledCells) {
        ...
        //if (newFilledCells == null) { THIS LINE CAUSES BUGS FOR HARDER SUDOKUS IF LEFT IN - I DON'T KNOW WHY
